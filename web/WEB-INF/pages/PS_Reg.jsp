...
<body>
    <form name="ps_reg.html" method="post" action="ps_reg_data.html">
	    <section class="h-100">
        ...
        <h1 class="fs-4 card-title fw-bold mb-4">Register</h1>
            ...
            Email is invalid
                ...
                <div class="mb-3">
                <label class="mb-2 text-muted" for="victim">Witness ID</label>
        ...
        <div class="mb-3">
            <label class="mb-2 text-muted" for="name">Relationship to Victim </label>
        ...
        <div class="mb-3">
            <label class="mb-2 text-muted" for="name">Witness Statement</label>
        ...
        <div class="mb-3">
         ...
         <div class="mb-3">
                <label class="mb-2 text-muted" for="name">Date of Witness Statement </label>
            ...
            <div class="mb-3">
                <label class="mb-2 text-muted" for="name">Victim's Statement</label>
