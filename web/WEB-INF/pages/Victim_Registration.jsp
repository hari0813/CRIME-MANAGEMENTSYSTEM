...
<body>
    <form name="victim_register" method="post" action="victim_register_data.html">
	    <section class="h-100">
        ...
        <h1 class="fs-4 card-title fw-bold mb-4">Register</h1>
            <form method="POST" class="needs-validation" novalidate="" autocomplete="off">
                ...
                <div class="mb-3">
                <label class="mb-2 text-muted" for="">Evidence  ID</label>
        ...
        <div class="mb-3">
            <label class="mb-2 text-muted" for="">Type of Evidence</label>
    ...
    Email is invalid
        ...
        <div class="mb-3">
            <label class="mb-2 text-muted" for="name">Collection Date </label>
            <input id="name" type="date" class="form-control" name="collection_date" required>
            <div class="invalid-feedback">
                Password is required
            </div>
        </div>
        <div class="mb-3">
         ...
         <div class="mb-3">
                <label class="mb-2 text-muted" for="name">Handling Officer </label>
            ...
            <div class="mb-3">
                <label class="mb-2 text-muted" for="name">Location of Evidence</label>
