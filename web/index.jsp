                        ...
                        <ul class="navbar-nav ml-auto mr-2">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="admin_reg.html">Admin Reg </a>
                                    <a class="dropdown-item" href="admin_login.html">Admin Login</a>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="investigation_register.html">I-Register</a>
                                    <a class="dropdown-item" href="i_login.html">I-Login</a>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="writer_reg.html">Writer Reg</a>
                                    <a class="dropdown-item" href="writer_login.html">Writer Login</a>
