                        ...
                        <ul class="navbar-nav ml-auto mr-2">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="Station_Reg_Form.html">Station Reg Form</a>
                                    <a class="dropdown-item" href="V_Register.html">Victim Registration</a>
                                    <a class="dropdown-item" href="FIR_Reg_Form.html">FIR Reg Form</a>
                                    <a class="dropdown-item" href="Charge_Sheet_Form.html">Charge Sheet Form</a>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="view_investigation_off.html">Investigation Officer  </a>
                                    <a class="dropdown-item" href="Investigation_Reg_Form.html">Investigation Reg </a>
                                    <a class="dropdown-item" href="W_Register.html">W-Register</a>
                                    <a class="dropdown-item" href="E_Register.html">E-Register</a>
                                    <a class="dropdown-item" href="C_Register.html">C-Register</a>
                                </div>
                            </li>
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-item" href="view_employee_reg.html">View Employee Reg</a>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="E_Register.html">Reg</a>
                                   
                                    <a class="dropdown-item" href="view_evidence.html">view Evidence</a>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="view_station.html">View Station</a>
                                    <a class="dropdown-item" href="view_victim.html">View Victim</a>
                                    <a class="dropdown-item" href="view_fir.html">View FIR</a>
                                    <a class="dropdown-item" href="view_charge.html">View Charge Sheet</a>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="view_investi.html">view Investigation </a>
                                    <a class="dropdown-item" href="view_witness.html">View Witness</a>
                                    <a class="dropdown-item" href="view_evidence.html">View Evidence </a>
                                    <a class="dropdown-item" href="view_crime.html">View Crime</a>
        ...
        <section class="layout_padding story_section">
            <div class="container-fluid">
                <div class="row">
                    <div class=" col-md-6">
                        <div>
                            <img class="img-fluid" src="img1.jpeg" alt="" />
                        </div>
                    </div>
                    <div class=" col-md-6">
