    ...
    <body>
        ...
        <table>
            ...
            <tbody id="witnessTable">
                <% List data = DBContext.getContext().readData("from Stationreg");
                    Iterator ite = data.iterator();
                    while (ite.hasNext()) {
        Stationreg s = (Stationreg) ite.next();%>
                <tr>
                    <td><%= s.getPolice_name()%></td>
                    <td><%= s.getPolice_id()%></td>
                    <td><%= s.getEmail()%></td>
                    <td><%= s.getContact()%></td>
                    <td><%= s.getAddress()%></td>
                    <td><%= s.getDate()%></td>
