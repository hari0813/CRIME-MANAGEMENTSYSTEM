                        ...
                        <ul class="navbar-nav ml-auto mr-2">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-item" href="C_Register.html">Crime Reg</a>
                                    <a class="dropdown-item" href="view_crime.html">View Crime Record</a>
                                </div>
                            </li>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="PS_Reg.html">PS Reg</a>
                                    <a class="dropdown-item" href="Employee_Reg.html">Employee Reg</a>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-item" href="E_Reg.html">Reg</a>
                                    <a class="dropdown-item" href="E_Update.html">Update</a>
                                </div>
                            </li>
