    ...
    <body>
        ...
        <table>
            ...
            <tbody id="chargeSheetTable">
                <% List data = DBContext.getContext().readData("from Chargesheet");
                    Iterator ite = data.iterator();
                    while (ite.hasNext()) {
   Chargesheet s = (Chargesheet) ite.next();%>
                <tr>
                    <td><%= s.getSheet_id()%></td>
                    <td><%= s.getAccused_name()%></td>
                    <td><%= s.getFir_num()%></td>
                    <td><%= s.getCrime_charge()%></td>
                    <td><%= s.getEvidence_link()%></td>
                    <td><%= s.getInvestigation_officer()%></td>
                    <td><%= s.getCourt_date()%></td>
