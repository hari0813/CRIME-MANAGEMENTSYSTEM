    ...
    <body>
        ...
        <div class="container">
            <table>
                ...
                <tbody>
                    <% List data = DBContext.getContext().readData("from Writerreg");
                        Iterator ite = data.iterator();
                        while (ite.hasNext()) {
Writerreg s = (Writerreg) ite.next();%>
                    <tr>
                        ...
                        <td><a href="delete_noticee.html?nid=<%= s.getUser_name()%>"><img src="images/images.png" height="20px" width="20px"/></a></td>
                    </tr>
                    <% }%>
                </tbody>
            </table>
