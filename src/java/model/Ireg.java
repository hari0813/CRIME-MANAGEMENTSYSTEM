...
@Table(name="ireg")
public class Ireg {
    private String charge_id , fir_num , accused_name;
    
    private String crime_charge , evidence_link , filling_date;
    
    private String investigation_officer , court_date;

    @Id
    @Column(name="chargeid",length = 130)
    ...
    @Column(name="accusedname",length = 350)
    ...
    @Column(name="crimecharge",length = 350)
    ...
    @Column(name="evidencelink",length = 320)
