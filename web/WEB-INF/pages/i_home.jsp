                        ...
                        <ul class="navbar-nav ml-auto mr-2">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="view_fir.html">View FIR-Details</a>
                                    <a class="dropdown-item" href="view_victim.html">View Victim Details</a>
                                    <a class="dropdown-item" href="view_witness.html">View Witness Details</a>
                                    <a class="dropdown-item" href="view_evidence.html">View Evidence Details</a>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="view_investi.html">Investigation </a>
                                    <a class="dropdown-item" href="update_investigation_form.html">Update Investigation</a>
                                    <a class="dropdown-item" href="view_investigation.html">View Investigation</a>
