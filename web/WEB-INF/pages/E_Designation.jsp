...
<body>
    <form name="edesignation_reg.html" method="post" action="edesignation_reg_data.html">
	    <section class="h-100">
        ...
        <h1 class="fs-4 card-title fw-bold mb-4">Register</h1>
            ...
            <div class="mb-3">
                ...
                <div class="mb-3">
                <label class="mb-2 text-muted" for="">Designation/Position   </label>
        ...
        <div class="mb-3">
            <label class="mb-2 text-muted" for="">Date of Assignment </label>
            <input id="date" type="date" class="form-control" name="date_of_assignment" required>
            <div class="invalid-feedback">
               
            </div>
        </div>
        <div class="mb-3">
            <label class="mb-2 text-muted" for="">Remarks </label>
            <input id="name" type="text" class="form-control" name="remarks" value="" required autofocus>
                <div class="invalid-feedback">
